...
const discordId = "1030495490963411045";
...
const reloadUser = async (data) => {
  ...
  $('div-img.avatar').css('background-image', `url(https://cdn.discordapp.com/avatars/1030495490963411045/18e85dc187b8a7fac931316bb0c12782.png?size=1024)`).removeAttr('loading');
  ...
  <a class="discord" href="https://discord.com/users/1030495490963411045" target="_blank">Discord</a>`);
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + '/users/Vaniellee/repos');
  ...
  const socials = [
    {
      ...
      href: 'https://discord.com/users/1030495490963411045',
      tippy: 'Instagram'
    },
    {
    ...
    },
    {
      ...
      href: `https://discord.gg/BnXJNMgV66`,
      tippy: 'Discord'
    },
    {
      ...
      href: 'https://github.com/Vaniellee',
      tippy: 'GitHub'
    }
  ];
